...
The OIDC/JWT token is set in the `X-Forwarded-Access-Token` header, to pass this on add this to the `authResponseHeaders` config option in traefik; the value is encrypt,
